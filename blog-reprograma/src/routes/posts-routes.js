...
/**@route PUT
 * @desc atualizar postagem
 * @access Public
 * @endpoint http://localhost:porta/posts/:id
 */
router.put('/posts:id', postsController.atualizarPost);


/**@route PATCH
 * @desc atualizar titulo da postagem
 * @access Public
 * @endpoint http://localhost:porta/posts/:id
 */
router.post('/posts/:id', postsController.atualizarTitulo);
