const controller = require('../controller/postagensController');
...
/*
@route GET titulo
@desc Retornar postagens por titulo
@access Public 
...
router.put('/:id', controller.atualizarPostagem);

router.patch('/:id', controller.atualizarTitulo);
