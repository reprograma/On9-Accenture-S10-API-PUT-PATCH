...
/**
@route PUT posts
@desc Atualizar o post
@access Public 
@endpoint http://localhost:porta/:id
**/
router.put('/posts', postController.atualizarPost);
...
@endpoint http://localhost:porta/:id
**/
router.put('/posts', postController.atualizarTitulo);

/**
@route PATCH posts
@desc Atualizar um campo (etiqueta) no post
@access Public 
@endpoint http://localhost:porta/id
**/
router.patch('/posts', postController.atualizarEtiquetaPost);
